...
function requireNone()
{
	if(getCheckedValue(document.forms['AppForm'].elements['savesub']) == "save")
	{
		...
		change('Q13binput01L', 'normal');
		change('Q13binput02L', 'normal');
		change('Q13cinput01L', 'normal');
		change('Q13cinput02L', 'normal');
		change('Q13dinput01L', 'normal');
		change('Q14input01L', 'normal');
		change('Q14input02L', 'normal');
		change('Q15input01L', 'normal');
		change('Q15input02L', 'normal');
	}
}
...
function Q13binput01UD() {
	if((getCheckedValue(document.forms['AppForm'].elements['savesub']) == "submit") && (getCheckedValue(document.forms['AppForm'].elements['Q13binput01']) == ""))
	{
		change('Q13binput01L', 'required');
	}
	else
	{
		change('Q13binput01L', 'normal');
	}
	if(getCheckedValue(document.forms['AppForm'].elements['Q13binput01']) == "Yes")
	{
		document.forms['AppForm'].elements['Q13binput02'].disabled=false;
	}
	else
	{
		document.forms['AppForm'].elements['Q13binput02'].disabled=true;
		change('Q13binput02L', 'normal');
	}

}
function Q13binput02UD() {
	if((getCheckedValue(document.forms['AppForm'].elements['savesub']) == "submit") && (getCheckedValue(document.forms['AppForm'].elements['Q13binput01']) == "Yes") && (getTextValue("Q13binput02") == ""))
	{
		change('Q13binput02L', 'required');
	}
	else
	{
		change('Q13binput02L', 'normal');
...
function Q13cinput01UD() {
	if((getCheckedValue(document.forms['AppForm'].elements['savesub']) == "submit") && (getCheckedValue(document.forms['AppForm'].elements['Q13cinput01']) == ""))
	{
		change('Q13cinput01L', 'required');
	}
	else
	{
		change('Q13cinput01L', 'normal');
	}
	if(getCheckedValue(document.forms['AppForm'].elements['Q13cinput01']) == "No")
	{
		document.forms['AppForm'].elements['Q13cinput02'].disabled=false;
	}
	else
	{
		document.forms['AppForm'].elements['Q13cinput02'].disabled=true;
		change('Q13cinput02L', 'normal');
	}

}
function Q13cinput02UD() {
	if((getCheckedValue(document.forms['AppForm'].elements['savesub']) == "submit") && (getCheckedValue(document.forms['AppForm'].elements['Q13cinput01']) == "No") && (getTextValue("Q13cinput02") == ""))
	{
		change('Q13cinput02L', 'required');
	}
	else
	{
		change('Q13cinput02L', 'normal');
...
function Q13dinput01UD() {
	if((getCheckedValue(document.forms['AppForm'].elements['savesub']) == "submit") && (getCheckedValue(document.forms['AppForm'].elements['Q13dinput01']) == ""))
	{
		change('Q13dinput01L', 'required');
	}
	else
	{
		change('Q13dinput01L', 'normal');
...
function Q14input01UD() {
	if((getCheckedValue(document.forms['AppForm'].elements['savesub']) == "submit") && (getCheckedValue(document.forms['AppForm'].elements['Q14input01']) == ""))
	{
		change('Q14input01L', 'required');
	}
	else
	{
		change('Q14input01L', 'normal');
	}
	if(getCheckedValue(document.forms['AppForm'].elements['Q14input01']) == "Yes")
	{
		document.forms['AppForm'].elements['Q14input02'].disabled=false;
	}
	else
	{
		document.forms['AppForm'].elements['Q14input02'].disabled=true;
		change('Q14input02L', 'normal');
	}

}
function Q14input02UD() {
	if((getCheckedValue(document.forms['AppForm'].elements['savesub']) == "submit") && (getCheckedValue(document.forms['AppForm'].elements['Q14input01']) == "Yes") && (getTextValue("Q14input02") == ""))
	{
		change('Q14input02L', 'required');
	}
	else
	{
		change('Q14input02L', 'normal');
...
function Q15input01UD() {
	if((getCheckedValue(document.forms['AppForm'].elements['savesub']) == "submit") && (getCheckedValue(document.forms['AppForm'].elements['Q15input01']) == ""))
	{
		change('Q15input01L', 'required');
	}
	else
	{
		change('Q15input01L', 'normal');
	}
	if(getCheckedValue(document.forms['AppForm'].elements['Q15input01']) == "Yes")
	{
		document.forms['AppForm'].elements['Q15input02'].disabled=false;
	}
	else
	{
		document.forms['AppForm'].elements['Q15input02'].disabled=true;
		change('Q15input02L', 'normal');
	}

}
function Q15input02UD() {
	if((getCheckedValue(document.forms['AppForm'].elements['savesub']) == "submit") && (getCheckedValue(document.forms['AppForm'].elements['Q15input01']) == "Yes") && (getTextValue("Q15input02") == ""))
	{
		change('Q15input02L', 'required');
	}
	else
	{
		change('Q15input02L', 'normal');
